...
#include "support/cdrom_util.hpp"
...
class CDROM {
  ...
  public:
    explicit CDROM(Scheduler& scheduler);
    ...
    static constexpr u32 durationToCycles(std::chrono::nanoseconds duration) {
        return duration.count() * 33868800 / 1'000'000'000;
    }
