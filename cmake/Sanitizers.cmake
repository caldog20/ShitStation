function(
    ...
    if(LIST_OF_SANITIZERS)
        if(NOT
            ...
            if(NOT MSVC)
                target_compile_options(${project_name} PRIVATE -fsanitize=${LIST_OF_SANITIZERS} -fno-omit-frame-pointer)
                target_link_options(${project_name} PRIVATE -fsanitize=${LIST_OF_SANITIZERS} -fno-omit-frame-pointer)
            else()
